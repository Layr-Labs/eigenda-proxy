...
## Equivalent to `test-e2e-testnet`, but against sepolia network instead of holesky
test-e2e-sepolia:
	BACKEND=sepolia gotestsum --format testname -- -v -timeout 60m ./test/e2e -parallel 32
