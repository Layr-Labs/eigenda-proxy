...
func (smb *StorageManagerBuilder) buildEigenDAV2Backend(ctx context.Context) (common.EigenDAStore, error) {
...
func (smb *StorageManagerBuilder) buildEigenDAV1Backend(ctx context.Context) (common.EigenDAStore, error) {
